...
typedef struct
{
	...
	lv_obj_t *screen_Confirm_label_3;
	lv_obj_t *screen_Confirm_label_4;
	lv_obj_t *screen_Confirm_label_5;
	lv_obj_t *screen_Confirm_cont_btns;
	lv_obj_t *screen_Confirm_btn_1;
	lv_obj_t *screen_Confirm_btn_1_label;
	lv_obj_t *screen_Confirm_btn_face;
	lv_obj_t *screen_Confirm_btn_face_label;
	lv_obj_t *screen_Confirm_control_bar;
	lv_obj_t *screen_Confirm_btn_2;
	lv_obj_t *screen_Confirm_btn_2_label;
	...
	lv_obj_t *screen_face_btn_1;
	lv_obj_t *screen_face_btn_1_label;
	...
	lv_obj_t *screen_success_label_21;
	lv_obj_t *screen_success_label_15;
	lv_obj_t *screen_success_label_16;
